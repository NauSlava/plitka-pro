# 🖥️ GUI Tester Documentation - Plitka Pro v4.5.06
...
- **Выбор пресетов** - пресеты из `gui_presets_v4.5.06.json`
...
- **Model URL:** r8.im/nauslava/plitka-pro-project:v4.5.06
- **Timeout:** 300 секунд
- **Retry attempts:** 3
